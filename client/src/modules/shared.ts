...
export const SUBMISSION_SIZE = 400;
export const DRAWING_BUFFER_SECS = 3;
export const VOTING_BUFFER_SECS = 2;

export const httpsRoot = `https://${window.location.host}`;
export const wsRoot = `wss://${window.location.host}/ws`;
export const isMobileClient = (function(a) {
...
// make sure colors are lowercase 6-character hex codes
const CORE_COLORS = [
	"#ee0000", // red
	"#ee9900", // orange
	"#e9e900", // yellow
